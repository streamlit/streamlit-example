...
st.markdown("<h1 style='text-align: justify; font-size: 16px; font-family: monospace;'>Прогнозирование количества людей с алкогольной и наркотической зависимостью от количества безработных имеет большое значение для разработки эффективных социальных программ и мер для борьбы с наркотиками и алкогольной зависимостью.</h1>", unsafe_allow_html=True)
