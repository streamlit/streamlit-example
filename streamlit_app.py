...
st.write("Прогнозирование количества людей с *алкогольной* и *наркотической* зависимостью от количества :c9af00[безработных] имеет большое значение для разработки эффективных социальных программ и мер для борьбы с наркотиками и алкогольной зависимостью.")
