...
# variables numériques
  ...
  hist = px.histogram(df2,x=option,color="deposit",barmode="group", color_discrete_sequence= px.colors.sequential.Plasma_r)
...
# variables catégorielles
  ...
  hist = px.histogram(df2,y=option,color="deposit",barmode="group", color_discrete_sequence= px.colors.sequential.Plasma_r)
...
# Comparaison des résultats -----------------------------------------------------------------------
  ...
  bar = px.bar(compare, x="Model", y=['accuracy', 'precision', 'rappel','roc'], barmode='group', color_discrete_sequence= px.colors.sequential.Plasma_r)
...
# Volet entrainement du modèle de la campagne -----------------------------------------------------------------------
  ...
  if col7.button('Lancer la prédiction'): 
    ...
    fig = px.histogram(probas,x="Probabilités",color="Classification", nbins=100, color_discrete_sequence= px.colors.sequential.Plasma_r)
    ...
    pie = px.pie(probas['Classification'].value_counts(), values='Classification', names='Classification', hole=.4,  color_discrete_sequence= px.colors.sequential.Plasma_r)
