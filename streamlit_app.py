...
if uploaded_file is not None:
    ...
    "Saturday": [(datetime(2023, 11, 25, 14, 0), datetime(2023, 11, 25, 22, 0))]
        ...
        total_duration_original = calculate_total_duration(schedule_df)
        ...
        st.write('Generated Schedules ...')
        total_duration_v1 = calculate_total_duration(schedule_df_v1)
        ...
        st.write('Generated Schedules ...')
        total_duration_mip = calculate_total_duration(schedule_df_mip)
