...
# Comparaison des résultats -----------------------------------------------------------------------
  ...
  fig.update_layout(height=400, width=500, legend=dict(orientation="h",yanchor="bottom", y=0.99, xanchor="left",x=0.01))
...
# Volet entrainement du modèle de la campagne -----------------------------------------------------------------------
  ...
  if col5.button('Lancer la prédiction'): 
    ...
    pie = px.pie(probas, values='Prédictions', names='Prédictions', hole=.3, title='Répartition des prédictions')
