...
st.write("<h1 style='text-align: justify; font-size: 18px; font-family: monospace; font-kerning: none; gap: 20px 10px;'>Прогнозирование количества людей с алкогольной и наркотической зависимостью от количества безработных имеет большое значение для разработки эффективных социальных программ и мер для борьбы с наркотиками и алкогольной зависимостью.</h1>", unsafe_allow_html=True)
st.write("<h1 style='text-align: justify; font-size: 18px; font-family: monospace; font-kerning: none; gap: 20px 10px;'>Безработные люди имеют повышенный риск развития алкогольной и наркотической зависимости, так как они часто сталкиваются с социальным и психологическим стрессом, чувством безнадёжности и неуверенности в будущем.</h1>", unsafe_allow_html=True)
st.write("<h1 style='text-align: justify; font-size: 18px; font-family: monospace; font-kerning: none; gap: 20px 10px;'>Учитывая все вышеперечисленные факторы, прогнозирование количества людей с алкогольной и наркотической зависимостью от количества безработных позволяет руководителям и специалистам в области здравоохранения и социальной защиты разработать целенаправленные программы и меры для профилактики и лечения этих проблем. Это также может помочь определить необходимость расширения и усиления социальной поддержки и проведения образовательных программ для безработных людей.</h1>", unsafe_allow_html=True)
st.image(image)
