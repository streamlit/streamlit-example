...
st.write("<h1 style='text-align: justify;>Прогнозирование количества людей с **алкогольной** и **наркотической** зависимостью от количества **безработных** имеет большое значение для разработки эффективных социальных программ и мер для борьбы с наркотиками и алкогольной зависимостью.</h1>")
