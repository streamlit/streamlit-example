...
def anaemia_analysis (hbdict):
	...
	if hblevel < 7:
		return "Your haemoglobin level is dangerously low. Please visit a doctor immediately."
	if hblevel < hbdict["hb"]["test_ref_min"]:
		if not hbdict["mcv"]["test_found"] or not hbdict["rbc_count"]["test_found"]:
			return "You have anaemia, but there is not enough information to determine the cause. Visit a doctor if you have any concerns of blood loss."
