...
def eda_advanced():
    ...
    df = load_data('https://bol.mondial-assistance.gr/Files/EDA_advanced/EDA_advanced_sample_12062023.csv').sample(n=1000)
...
def data_viz():
    ...
    df = load_data('https://bol.mondial-assistance.gr/Files/Dataviz/Dataviz_12_06_2023.csv').sample(n=1000)
