...
int = st.number_input("Intersection")
...
atm = st.number_input("central solid land in meter")
nbv = st.number_input("Number of lanes")
atm = st.number_input("Atmospheric Condition")
year = st.number_input("year")
month = st.number_input("month")
day = st.number_input("day")
hrmm = st.number_input("hrmm")
dfpredict = pd.DataFrame([[agg, catr, prof, com, col, larrout, situ, dep, lartpc, int, circ, nbv, atm, severity, year, month, day, hrmn]], columns=[agg, catr, prof, com, col, larrout, situ, dep, lartpc, int, circ, nbv, atm, severity, year, month, day, hrmn]))
